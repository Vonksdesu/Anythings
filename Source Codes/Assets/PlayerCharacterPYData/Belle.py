...
def get_hash_commands(log, update_hash, comment_sections, comment_commandlists,
    ...
    return {
# === IB Hashes ===
'bea4a483': [(log, ('2.8: Belle Hair IB Hash',)),                         (add_ib_check_if_missing,)],
'1817f3ca': [(log, ('2.8: Belle Body IB Hash',)),                         (add_ib_check_if_missing,)],
...
# === VB Hashes ===
# Hair
'142ddbbc': [(log, ('2.8: Belle Hair draw_vb',)),                         (add_section_if_missing, ('bea4a483', 'Belle.Hair.IB', 'match_priority = 0\n'))],
'a9673001': [(log, ('2.8: Belle Hair position_vb',)),                     (add_section_if_missing, ('bea4a483', 'Belle.Hair.IB', 'match_priority = 0\n'))],
'11e38ebb': [(log, ('2.8: Belle Hair texcoord_vb',)),                     (add_section_if_missing, ('bea4a483', 'Belle.Hair.IB', 'match_priority = 0\n'))],
'cc32660c': [(log, ('2.8: Belle Hair blend_vb',)),                        (add_section_if_missing, ('bea4a483', 'Belle.Hair.IB', 'match_priority = 0\n'))],

# Body
'ac1c8f80': [(log, ('2.8: Belle Body draw_vb',)),                         (add_section_if_missing, ('1817f3ca', 'Belle.Body.IB', 'match_priority = 0\n'))],
'd2844c01': [(log, ('2.8: Belle Body position_vb',)),                     (add_section_if_missing, ('1817f3ca', 'Belle.Body.IB', 'match_priority = 0\n'))],
'801edbf4': [(log, ('2.8: Belle Body texcoord_vb',)),                     (add_section_if_missing, ('1817f3ca', 'Belle.Body.IB', 'match_priority = 0\n'))],
'c92a17d8': [(log, ('2.8: Belle Body blend_vb',)),                        (add_section_if_missing, ('1817f3ca', 'Belle.Body.IB', 'match_priority = 0\n'))],
...
'1de8fc08': [(log, ('2.8: Belle Face texcoord_vb',)),                     (add_section_if_missing, ('9a9780a7', 'Belle.Face.IB', 'match_priority = 0\n'))],
'36138f65': [(log, ('2.8: Belle Face blend_vb',)),                        (add_section_if_missing, ('9a9780a7', 'Belle.Face.IB', 'match_priority = 0\n'))],
...
# === Shared Normal Map ===
'798adba3': [
        (log,                           ('2.8: Belle Shared NormalMap Hash',)),
        (add_section_if_missing,        ('bea4a483', 'Belle.Hair.IB', 'match_priority = 0\n')),
        (add_section_if_missing,        ('1817f3ca', 'Belle.Body.IB', 'match_priority = 0\n')),
    ],
'f44f330b': [
